...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Susu</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="sidebar-menu nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @hasanyrole('ADMIN|OPD UNIT|DOCTOR|PHARMACY|CASHIER|LABORATORY')

          <li class="nav-item treeinfo">
          ...
          @hasanyrole('ADMIN')
          <li class="nav-item">
            <a href="#" class="nav-link treeinfo">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('add-user-role') }}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Role</p>
                </a>
              </li>
          ...
          @hasanyrole('ADMIN|DOCTOR')
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('allpaientsdoc') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Patients</p>
                </a>
              </li>
...
@endhasanyrole
          @hasanyrole('ADMIN|LABORATORY')
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('labsearch') }}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Search</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('allpaientslab') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Patients</p>
                </a>
              </li>
...
@endhasanyrole
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('pharsearch') }}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Search</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('allpaientsphar') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Patients</p>
                </a>
              </li>
...
@endhasanyrole
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('cashiersearch') }}" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Search</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019-2020 <a href="https://adminlte.io">HMS</a>.</strong>
    All rights reserved.

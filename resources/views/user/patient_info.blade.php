 ...
 <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Drug Description</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive"> 
                <form method="post" action="{{ route('save-doc') }}">
                  ...
                  <div class="form-group">
                    <label for="drugs">Type Drugs Here</label>
                  ...
                  <a href="{{ route('getinfoall',['cardid'=>$row->cardid]) }}" class="btn btn-secondary">View Previous Information</a>
                </div>

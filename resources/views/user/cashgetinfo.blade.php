 ...
 <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Drug Prescription</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive"> 
                <form method="post" action="{{ route('save-doc') }}">
                  @csrf

                  <input type="hidden" name="hiddenid" value="{{$row->id}}">

                  <div class="form-group">
                    <label for="drugs">Drug Prescription</label>
                  ...
                  <div class="form-group">
                    <label for="drugs">Doctor's Name</label>
        ...
        <tr>
          ...
          <div class="col-md-6">
            ...
            <!------ Cashier Add Cost Details -->
            <!-- general form elements disabled -->
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Cashier Costs Input</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive"> 
                <form method="post" action="{{ route('cashsave') }}">
                  @csrf

                  <input type="hidden" name="hiddenid" value="{{$row->id}}">

                  <div class="form-group">
                    <label for="btc">Blood Test Cost</label>
                    <input type="text" name="btc" value="{{old('btc',$row->Btc)}}" class="form-control" >
                    @error('btc') 
                       <span class="input-group text-danger" role="alert">
                          <strong>{{$message}}</strong>
                    </span>
                  @enderror
                   ...
                   <div class="form-group">
                    <label for="utc">Urine Test Cost</label>
                    <input type="text" name="utc" value="{{old('utc',$row->Utc)}}" class="form-control" >
                    @error('utc') 
                       <span class="input-group text-danger" role="alert">
                          <strong>{{$message}}</strong>
                    </span>
                  @enderror
                   ...
                   <div class="form-group">
                    <label for="dtc">Drug Test Cost</label>
                    <input type="text" name="dtc" value="{{old('dtc',$row->Dc)}}" class="form-control" >
                    @error('dtc') 
                       <span class="input-group text-danger" role="alert">
                          <strong>{{$message}}</strong>
                    </span>
